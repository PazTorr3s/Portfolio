...
const Hero = () => {
  ...
  const subtitle =
    lang === "en"
      ? "Web developer who enjoys building everything from Front-end interfaces to Back-end logic and data management."
      : "Desarrolladora web que disfruta construir desde interfaces en Front-end hasta lógica de Back-end y manejo de datos."
